    ...
    return (
        <div className="flex justify-center items-center min-h-screen" style={{ backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), url(${Bg})`, backgroundSize: 'cover', backgroundColor: 'rgba(0, 0, 0, 0.9)' }}>
            <div className="text-center">
                ...
                <div>
                    <Typed
                        className='text-lg md:text-2xl lg:text-3xl font-extrabold leading-none tracking-tight text-purple-700 dark:text-purple-600'
                ...
                <p className="mt-4 mb-6 text-sm md:text-sm lg:text-base font-normal text-gray-700 sm:px-8 md:px-16 xl:px-48 mx-4 dark:text-gray-700" style={{ fontFamily: 'Inter, sans-serif' }}>
                ...
                <Link to='/reports'>
                    <p className="inline-flex items-center justify-center px-4 py-2 text-xs md:text-sm lg:text-base font-medium text-center text-white bg-purple-700 rounded-lg hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 dark:focus:ring-purple-900 transform hover:scale-110" style={{ fontFamily: 'Inter, sans-serif' }}>
                        Get Started
